...
public class ItinerariesServletTest {

	private ItinerariesServlet itinerariesServlet;
	...
	public void setUp(AemContext context) throws IOException {
		itinerariesServlet = new ItinerariesServlet();
...
//		when(context.request().getResourceResolver()).thenReturn(context.resourceResolver());
	...
	public void test(AemContext context)
		...
		itinerariesServlet.doGet(context.request(), context.response());
