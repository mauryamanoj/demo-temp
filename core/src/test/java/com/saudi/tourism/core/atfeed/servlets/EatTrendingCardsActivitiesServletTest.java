...
public class EatTrendingCardsActivitiesServletTest {

	private EatTrendingCardsActivitiesServlet eatTrendingCardsActivitiesServlet;
	...
	public void setUp(AemContext context) throws IOException {
		eatTrendingCardsActivitiesServlet = new EatTrendingCardsActivitiesServlet();
...
//		when(context.request().getResourceResolver()).thenReturn(context.resourceResolver());
	...
	public void test(AemContext context)
		...
		eatTrendingCardsActivitiesServlet.doGet(context.request(), context.response());
