...
public class AIRExploreRegionServletTest {

	private AIRExploreRegionServlet airExploreRegionServlet;
	...
	public void setUp(AemContext context) throws IOException {
		airExploreRegionServlet = new AIRExploreRegionServlet();
...
//		when(context.request().getResourceResolver()).thenReturn(context.resourceResolver());
	...
	public void test(AemContext context)
		...
		airExploreRegionServlet.doGet(context.request(), context.response());
