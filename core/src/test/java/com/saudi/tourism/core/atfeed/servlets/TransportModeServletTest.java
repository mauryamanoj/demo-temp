...
public class TransportModeServletTest {

	private TransportModeServlet transportModeServlet;
	...
	public void setUp(AemContext context) throws IOException {
		transportModeServlet = new TransportModeServlet();
...
//		when(context.request().getResourceResolver()).thenReturn(context.resourceResolver());
	...
	public void test(AemContext context)
		...
		transportModeServlet.doGet(context.request(), context.response());
