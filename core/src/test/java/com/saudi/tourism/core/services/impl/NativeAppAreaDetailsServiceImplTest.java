...
class NativeAppAreaDetailsServiceImplTest {
  ...
  private NativeAppAreaDetailsServiceImpl nativeAppAreaDetailsService;
  ...
  void setUp(final AemContext aemContext) throws RepositoryException {
    ...
    nativeAppAreaDetailsService = new NativeAppAreaDetailsServiceImpl();
    aemContext.registerInjectActivateService(nativeAppAreaDetailsService);
  ...
  void getAreaDetailsShouldHandleShoppingArticleDetails(final AemContext aemContext) throws RepositoryException {
    ...
    //Act
    nativeAppAreaDetailsService.getAreaDetails(request);
