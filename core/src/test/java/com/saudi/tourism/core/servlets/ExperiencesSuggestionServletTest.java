...
public class ExperiencesSuggestionServletTest {

  @InjectMocks
  private ExperienceSuggestionsServlet servlet;
  ...
  public void testExperienceSuggestionAPIPostiveCase(AemContext context)
    ...
    when(service.getExperienceSuggestion(queryStrings, experienceId)).thenReturn(new Object());
  ...
  public void testExperienceSuggestionAPIExceptionCase(AemContext context) throws ServletException, IOException {
    ...
    queryStrings.put("experienceId", experienceId);
    context.request().setParameterMap(queryStrings);
    when(service.getExperienceSuggestion(queryStrings, experienceId)).thenThrow(NullPointerException.class);
    servlet.doGet(context.request(), context.response());
