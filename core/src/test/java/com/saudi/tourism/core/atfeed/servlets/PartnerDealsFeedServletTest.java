...
public class PartnerDealsFeedServletTest {

	private PartnerDealsFeedServlet partnerDealsFeedServlet;
	...
	public void setUp(AemContext context) throws IOException {
		partnerDealsFeedServlet = new PartnerDealsFeedServlet();
...
//		when(context.request().getResourceResolver()).thenReturn(context.resourceResolver());
	...
	public void test(AemContext context)
		...
		partnerDealsFeedServlet.doGet(context.request(), context.response());
