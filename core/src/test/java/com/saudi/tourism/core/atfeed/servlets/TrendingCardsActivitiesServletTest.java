...
public class TrendingCardsActivitiesServletTest {

	private TrendingCardsActivitiesServlet trendingCardsActivitiesServlet;
	...
	public void setUp(AemContext context) throws IOException {
		trendingCardsActivitiesServlet = new TrendingCardsActivitiesServlet();
...
//		when(context.request().getResourceResolver()).thenReturn(context.resourceResolver());
	...
	public void test(AemContext context)
		...
		trendingCardsActivitiesServlet.doGet(context.request(), context.response());
