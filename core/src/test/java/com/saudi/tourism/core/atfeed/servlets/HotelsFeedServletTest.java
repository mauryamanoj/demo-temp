...
public class HotelsFeedServletTest {

	private HotelsFeedServlet hotelsFeedServlet;
	...
	public void setUp(AemContext context) throws IOException {
		hotelsFeedServlet = new HotelsFeedServlet();
...
//		when(context.request().getResourceResolver()).thenReturn(context.resourceResolver());
	...
	public void test(AemContext context)
		...
		hotelsFeedServlet.doGet(context.request(), context.response());
