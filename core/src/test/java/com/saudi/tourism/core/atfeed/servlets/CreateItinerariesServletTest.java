...
public class CreateItinerariesServletTest {

	private CreateItinerariesServlet createItinerariesServlet;
	...
	public void setUp(AemContext context) throws IOException {
		createItinerariesServlet = new CreateItinerariesServlet();
...
//		when(context.request().getResourceResolver()).thenReturn(context.resourceResolver());
	...
	public void test(AemContext context)
		...
		createItinerariesServlet.doGet(context.request(), context.response());
