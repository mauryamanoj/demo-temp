...
public class FoodAndDrinkServletTest {

	private FoodAndDrinkServlet foodAndDrinkServlet;
	...
	public void setUp(AemContext context) throws IOException {
		foodAndDrinkServlet = new FoodAndDrinkServlet();
...
//		when(context.request().getResourceResolver()).thenReturn(context.resourceResolver());
	...
	public void test(AemContext context)
		...
		foodAndDrinkServlet.doGet(context.request(), context.response());
