...
public class AIRExperiencesServletTest {

	private AIRExperiencesServlet airExperiencesServlet;
	...
	public void setUp(AemContext context) throws IOException {
		airExperiencesServlet = new AIRExperiencesServlet();
...
//		when(context.request().getResourceResolver()).thenReturn(context.resourceResolver());
	...
	public void test(AemContext context)
		...
		airExperiencesServlet.doGet(context.request(), context.response());
