...
public class AttractionsFeedServletTest {

	private AttractionsFeedServlet attractionsFeedServlet;
	...
	public void setUp(AemContext context) throws IOException {
		attractionsFeedServlet = new AttractionsFeedServlet();
	...
	public void test(AemContext context)
		...
		attractionsFeedServlet.doGet(context.request(), context.response());
