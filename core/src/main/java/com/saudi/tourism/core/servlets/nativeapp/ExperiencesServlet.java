 ...
 * http://localhost:4502/bin/api/v2/experience . Sample URL :
 */
@Component(service = Servlet.class, property = {
      ...
      ServletResolverConstants.SLING_SERVLET_PATHS + Constants.EQUAL + "/bin/api/v2/app/experience"})
@Slf4j
  ...
  protected void doGet(SlingHttpServletRequest request, SlingHttpServletResponse response)
    ...
    try {
      ...
      if ((source.equals("web") && adminOptions.isDisableWebHalayallaPackages())
        ...
        CommonUtils.writeNewJSONFormat(response, StatusEnum.SUCCESS.getValue(),
              service.getAllExperiences(RestHelper.getParameters(request)).toString());
