...
import static com.saudi.tourism.core.login.servlets.v2.SSIDLogoutServlet.SERVLET_PATH;
import static com.saudi.tourism.core.login.servlets.v2.SSIDLogoutServlet.DESCRIPTION;

/**
 * The Get logout V2 servlet for SSID.
 */
...
public class SSIDLogoutServlet extends SlingSafeMethodsServlet {
   ...
   */
  public static final String SERVLET_PATH = "/bin/api/v2/ssid/logout";

  /**
   * This servlet description.
   */
  static final String DESCRIPTION = "Get SSID Logout V2 Servlet";
  ...
  public void doGet(SlingHttpServletRequest request, SlingHttpServletResponse response)
    ...
    final Cookie idToken = request.getCookie("id_token");
