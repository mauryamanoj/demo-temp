...
import static com.saudi.tourism.core.servlets.TripPlanServlet.DESCRIPTION;
...
@Component(service = Servlet.class,
           ...
           property = {Constants.SERVICE_DESCRIPTION + Constants.EQUAL + DESCRIPTION,
               ...
               SLING_SERVLET_PATHS + Constants.EQUAL + TripPlanServlet.SERVLET_PATH})
@Slf4j
public class TripPlanServlet extends BaseAllMethodsServlet {
  ...
  public static final String SERVLET_PATH = "/bin/api/v1/trip-plan";
