...
import com.saudi.tourism.core.models.components.contentfragment.activity.ActivityCFModel;
...
/** Adapts Activity CF to ThingToDoModel. */
@Component(service = ThingToDoCFAdapter.class, immediate = true)
public class ThingToDoActivityCFAdapter implements ThingToDoCFAdapter, ContentFragmentAwareModel {
  @Override
  ...
  public ThingToDoModel adaptTo(Adaptable adaptable) {
    final var model = adaptable.adaptTo(ActivityCFModel.class);
