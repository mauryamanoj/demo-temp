...
@Getter
public class SubFragmentContainer {
  /**
   * copyrights of the fragment.
   */
  @ValueMapValue
  @Expose
  ...
  /**
   * upArrowCta of the fragment.
   */
  @ValueMapValue
  @Expose
  private String upArrowCta;


  /**
   * privacyList of the fragment.
   */
  @ValueMapValue
