...
@Component(service = Servlet.class, property = {
    ...
    ServletResolverConstants.SLING_SERVLET_PATHS + Constants.EQUAL + "/bin/api/v1/bookings" })
@Slf4j
public class MyBookingsServlet extends SlingAllMethodsServlet {
   ...
   */
  @Reference
  private transient LoginUserService loginservice;
  ...
  private Object getHalaYallaUserId(SlingHttpServletRequest request,
    ...
    try {
      String userprofile = loginservice.getUserDetails(GetUserDetailsServlet.getUserID(request),
          LoginUserServiceImpl.PROFILE);
