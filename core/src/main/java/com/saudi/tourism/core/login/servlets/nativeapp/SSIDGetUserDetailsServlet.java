...
import static com.saudi.tourism.core.login.servlets.nativeapp.SSIDGetUserDetailsServlet.DESCRIPTION;
import static com.saudi.tourism.core.login.servlets.nativeapp.SSIDGetUserDetailsServlet.SERVLET_PATH;
...
public class SSIDGetUserDetailsServlet extends BaseAllMethodsServlet {
  ...
  public static final String SERVLET_PATH = "/bin/api/v3/user/get";
  /**
   * This servlet description.
   */
  static final String DESCRIPTION = "Get User Servlet v3";
