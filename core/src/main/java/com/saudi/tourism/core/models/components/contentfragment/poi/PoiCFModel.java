package com.saudi.tourism.core.models.components.contentfragment.poi;
...
@AllArgsConstructor
@Slf4j
public class PoiCFModel implements ContentFragmentAwareModel, BannerImageAwareModel, TimingsAwareModel {
  /** POI ContentFragment Model. */
  @Self
  ...
  void init() {
    ...
    type = getElementValue(contentFragment, "type", String.class);
    ...
    typeValue = getElementValue(contentFragment, "typeValue", String.class);
    ...
    sameTimeAcrossWeek = Optional.ofNullable(getElementValue(contentFragment,
        "sameTimeAcrossWeek", Boolean.class)).orElse(false);
