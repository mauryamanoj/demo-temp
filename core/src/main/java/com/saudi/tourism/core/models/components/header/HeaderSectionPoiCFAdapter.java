...
public class HeaderSectionPoiCFAdapter implements HeaderSectionCFAdapter, ContentFragmentAwareModel {
  ...
  public boolean supports(Adaptable adaptable) {
    ...
    return StringUtils.equals("poi", cf.getTemplate().getTitle().toLowerCase());
  }
