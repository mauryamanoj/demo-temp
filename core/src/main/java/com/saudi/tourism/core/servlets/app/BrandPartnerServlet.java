 ...
 * /bin/api/v1/app/earning/partners?locale=en&new=true&limit=10
 * /bin/api/v1/app/earning/partners?locale=en&close=true&limit=10&latitude=12&longitude=40
 * /bin/api/v1/app/earning/partners?locale=en&homePage=true&latitude=12&longitude=40
 * /bin/api/v1/app/earning/partners?locale=en&popular=true&limit=7
 *
 */
@Component(service = Servlet.class,
    property = {Constants.SERVICE_DESCRIPTION + Constants.EQUAL + "Brand Partner Servlet",
...
public class BrandPartnerServlet extends SlingAllMethodsServlet {
  ...
  public static final String SERVLET_PATH = "/bin/api/v1/app/earning/partners";
  /**
  ...
  protected void doGet(SlingHttpServletRequest request, SlingHttpServletResponse response)
    ...
    try {
      ...
      if (StringUtils.isBlank(brandRequestParams.getLocale())) {
        ...
        CommonUtils.writeJSONExclude(response, StatusEnum.SUCCESS.getValue(), homePageListMap);
      } else {
