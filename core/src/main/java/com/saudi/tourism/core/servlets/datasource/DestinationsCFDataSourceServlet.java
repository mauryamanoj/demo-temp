...
import static com.saudi.tourism.core.servlets.datasource.DestinationsCFDataSourceServlet.DESCRIPTION;
import static com.saudi.tourism.core.servlets.datasource.DestinationsCFDataSourceServlet.RESOURCE_TYPE_VALUE;
 ...
 * sauditourism/datasource/destinations"
 */
@Component(
...
@Slf4j
public class DestinationsCFDataSourceServlet extends SlingSafeMethodsServlet {
  /** This data source servlet description. */
  static final String DESCRIPTION = "Saudi Tourism - Destinations CF Datasource Servlet";

  /** This servlet processing resource type. */
  static final String RESOURCE_TYPE_VALUE = "sauditourism/datasource/destinations";
  ...
  protected void doGet(
    ...
    final var list = destinationsCFService.fetchAllDestination(locale);
