package com.saudi.tourism.core.models.components.contentfragment.activity;
...
/**
 * This is the Sling Model class for the Content Fragment component for Activity. The {@link
 * Model} annotation allows us to register the class as a Sling Model.
 */
@Model(
    adaptables = {Resource.class, ContentFragment.class},
    adapters = ActivityCFModel.class,
...
@AllArgsConstructor
@Slf4j
public class ActivityCFModel implements ContentFragmentAwareModel, BannerImageAwareModel, TimingsAwareModel {
