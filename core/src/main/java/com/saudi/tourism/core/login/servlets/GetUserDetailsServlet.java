...
import com.saudi.tourism.core.login.services.impl.LoginUserServiceImpl;
...
import static com.saudi.tourism.core.login.servlets.GetUserDetailsServlet.DESCRIPTION;
import static com.saudi.tourism.core.login.servlets.GetUserDetailsServlet.SERVLET_PATH;
...
@Component(service = Servlet.class,
           property = {Constants.SERVICE_DESCRIPTION + Constants.EQUAL + DESCRIPTION,
               ...
               ServletResolverConstants.SLING_SERVLET_PATHS + Constants.EQUAL
                   + SERVLET_PATH})
@Slf4j
public class GetUserDetailsServlet extends BaseAllMethodsServlet {
  /**
   * Possible paths for this servlet.
   */
  @SuppressWarnings("java:S1075")
  public static final String SERVLET_PATH = "/bin/api/v1/user/get";
  /**
   * This servlet description.
   */
  static final String DESCRIPTION = "Get User Servlet";
  ...
  private static final Map<String, Set<String>> ALLOWED_PARAMS = ImmutableMap.of(
      //@formatter:off
      LoginUserServiceImpl.TRIPS, ImmutableSet.of(Constants.PN_LOCALE, Constants.PN_ID),
      LoginUserServiceImpl.FAVORITES, ImmutableSet.of(Constants.PN_LOCALE, PN_TRIP_PLAN,
          Constants.CITY)
      //@formatter:on
  );
