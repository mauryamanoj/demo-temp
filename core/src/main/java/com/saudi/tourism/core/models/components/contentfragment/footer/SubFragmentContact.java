...
@Getter
public class SubFragmentContact {
  /**
   * callCenterTitle of the fragment.
   */
  @ValueMapValue(name = "callCenterTitle")
  @Expose
  private String titleLink;

  /**
   * ctaCallCenterList of the fragment.
   */
  @ValueMapValue
  private List<String> ctaCallCenterList;
  ...
  public void init() throws RepositoryException, JsonProcessingException {
    ...
    for (String cta : ctaCallCenterList) {
