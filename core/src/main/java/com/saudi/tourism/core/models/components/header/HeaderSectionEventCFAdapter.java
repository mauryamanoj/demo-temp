...
public class HeaderSectionEventCFAdapter implements HeaderSectionCFAdapter, ContentFragmentAwareModel {
  ...
  public boolean supports(Adaptable adaptable) {
    ...
    return StringUtils.equals("event", cf.getTemplate().getTitle().toLowerCase());
  }
  ...
  public HeaderSectionCFModel adaptTo(Adaptable adaptable) {
    ...
    var s7titleImage = getElementValue(cf, "s7titleImage", String.class);
    var alt = getElementValue(cf, "alt", String.class);
    var titleImage = getElementValue(cf, "titleImage", String.class);
    var altTitleImage = getElementValue(cf, "altTitleImage", String.class);
    return HeaderSectionCFModel.builder()
      ...
      .s7image(s7image)
      .s7titleImage(s7titleImage)
      .titleImage(titleImage)
      .altTitleImage(altTitleImage)
      .alt(alt)
      .build();
  }
}
