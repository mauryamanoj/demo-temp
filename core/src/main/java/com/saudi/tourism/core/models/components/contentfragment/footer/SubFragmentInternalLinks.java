...
@Getter
public class SubFragmentInternalLinks {

  /**
   * titleLink of the fragment.
   */
  @ValueMapValue
  @Expose
  private String titleLink;
  /**
   * ctaDiscoverList of the fragment.
   */
  @ValueMapValue
  private List<String> ctaDiscoverList;
  ...
  public void init() throws RepositoryException, JsonProcessingException {
    ...
    for (String cta : ctaDiscoverList) {
