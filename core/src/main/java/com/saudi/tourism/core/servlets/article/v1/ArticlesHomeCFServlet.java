...
import static com.saudi.tourism.core.servlets.article.v1.ArticlesHomeCFServlet.SERVLET_PATH;

/** Servlet to fetch Articles Home. */
@Component(
    service = Servlet.class,
    property = {
      Constants.SERVICE_DESCRIPTION + Constants.EQUAL + "Articles Home Servlet",
...
@Slf4j
public class ArticlesHomeCFServlet extends SlingAllMethodsServlet {

  /**
   * Possible paths for this servlet.
   */
  @SuppressWarnings("java:S1075")
  public static final String SERVLET_PATH = "/bin/api/v1/articles/home";
  ...
  protected void doGet(SlingHttpServletRequest request, SlingHttpServletResponse response)
    ...
    try {
      ...
      final var model = articlesCFService.getArticlesHome(fetchArticlesRequest);
      CommonUtils.writeNewJSONFormat(
          response,
      ...
      LOGGER.error("Error to fetch Articles Home from CF", e);
      CommonUtils.writeNewJSONFormat(
