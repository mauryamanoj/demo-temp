...
import static com.saudi.tourism.core.login.servlets.UpdateUserDetailsServlet.SERVLET_PATH;
...
@Component(service = Servlet.class,
           property = {Constants.SERVICE_DESCRIPTION + Constants.EQUAL + "Update User Servlet",
               ...
               ServletResolverConstants.SLING_SERVLET_PATHS + Constants.EQUAL
                   + SERVLET_PATH})
@Slf4j
public class UpdateUserDetailsServlet extends BaseAllMethodsServlet {

  /**
   * Possible paths for this servlet.
   */
  @SuppressWarnings("java:S1075")
  public static final String SERVLET_PATH = "/bin/api/v1/user/update";
  ...
  @Override protected void doPut(SlingHttpServletRequest request, SlingHttpServletResponse response)
    ...
    try {
      ...
      outError(request, response, StatusEnum.INTERNAL_SERVER_ERROR, e,
          "Error in user profile update module");
    }
  }
  ...
  public static String handlePath(String jsonRequestText, final String type) {
    if (LoginUserServiceImpl.FAVORITES.equals(type)) {
