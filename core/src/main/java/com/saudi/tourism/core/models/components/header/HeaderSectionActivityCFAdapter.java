...
public class HeaderSectionActivityCFAdapter implements HeaderSectionCFAdapter, ContentFragmentAwareModel {
  ...
  public boolean supports(Adaptable adaptable) {
    ...
    return StringUtils.equals("activity", cf.getTemplate().getTitle().toLowerCase());
  }
