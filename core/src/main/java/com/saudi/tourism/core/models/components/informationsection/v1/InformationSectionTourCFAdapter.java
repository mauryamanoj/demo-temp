...
/** Adapts tour to information section CF model. */
@Component(service = InformationSectionCFAdapter.class, immediate = true)
public class InformationSectionTourCFAdapter implements InformationSectionCFAdapter, ContentFragmentAwareModel {
  @Override
